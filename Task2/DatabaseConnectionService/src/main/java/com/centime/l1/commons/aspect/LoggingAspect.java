...
public class LoggingAspect {
    ...
    @Before("@annotation(com.centime.l1.dbconnectionservice.annotation.LogMethodParam)")
    public void logMethodParams(JoinPoint joinPoint) throws Throwable {
        ...
        log.info("Method : {}, traceID : {}",methodName, traceId);
        log.info("Method Arguments Passed as method is annotated with LogMethodParam annotation : {}", Arrays.asList(params));
